	...
	module HTTP
		module Header
			...
			class TransferEncoding < Split
				...
				# Initializes the transfer encoding header with already-parsed and normalized values.
				#
				...
				# Adds one or more comma-separated values to the transfer encoding header from a raw wire-format string. The values are converted to lowercase for normalization.
				#
